...
public class Pagination {
	...
	public Pagination(ParameterForm params) {
		this.params = params;
		calculate();
	}

	public ParameterForm getParams() {
		return params;
	}

	public void setParams(ParameterForm params) {
		this.params = params;
	}
	...
	public static void main(String[] args) {
		ParameterForm params = ParameterForm.builder()
				.elementSize(15)
				.pageSize(5)
				.requestPage(25)
				.rowCount(2048)
