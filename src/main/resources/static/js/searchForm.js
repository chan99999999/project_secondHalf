...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div
    mapOption = {
        center: new kakao.maps.LatLng(37.65146111, 127.0583889), // 지도의 중심좌표 (노원구 중심)
        level: 3 // 지도의 확대 레벨
    };
...
function searchPlaces() {
    ...
    // 검색할 영역의 중심 좌표와 반경을 설정합니다
    var center = new kakao.maps.LatLng(37.65146111, 127.0583889); // 노원구 중심 좌표
    var radius = 5000; // 반경 5km
...
function getListItem(index, places) {
    ...
    el.className = 'item';
    el.setAttribute('data-id', places.id); // 장소의 식별자를 데이터 속성으로 추가
